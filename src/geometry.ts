...
// ViewBox: 0 0 600 780
export const VIEWBOX = { width: 600, height: 780 };
...
export const CHANNEL_PATHS: ChannelPath[] = [
  ...
  {
    gates: [20, 57],
    // Throat→Spleen — long arc going lower-left
    path: 'M 325,250 C 325,290 270,310 240,320 C 185,340 160,375 152,390',
  },
  {
    gates: [34, 20],
    path: 'M 258,415 C 258,390 270,360 270,340 C 270,310 280,280 280,250 L 325,250',
  },
  {
    gates: [7, 31],
  ...
  // Root lateral
  {
    gates: [58, 18],
    // Spleen↔Root arc
    path: 'M 152,458 C 152,480 180,508 262,508',
  },
  {
    gates: [38, 28],
    path: 'M 135,443 C 130,475 170,505 278,508',
  },
  {
    gates: [54, 32],
    path: 'M 152,428 C 145,465 185,505 294,508',
  },
  // 10-57 (G↔Spleen): arc from G gate 10 (x=225,y=335) to Spleen gate 57 (x=128,y=383)
  {
    gates: [10, 57],
    path: 'M 225,335 C 195,345 160,360 128,383',
  },
  // 18-58 (Spleen↔Root): arc from Spleen gate 18 (x=128,y=458) to Root gate 58 (x=262,y=508)
  {
    gates: [18, 58],
    path: 'M 128,458 C 120,480 180,505 262,510',
  },
  ...
  // 37-40 (SolarPlexus↔Ego): arc right side connecting SP gate 37 (x=472,y=398) to Ego gate 40 (x=390,y=322)
  {
    gates: [37, 40],
    path: 'M 472,398 C 510,375 505,335 390,322',
  },
  ...
  // 16-48 (Throat↔Spleen): long arc
  {
    gates: [16, 48],
    path: 'M 360,448 C 380,470 300,510 220,490 C 175,478 152,450 152,368',
  },
  // 11-56 (Ajna↔Throat)
  {
    gates: [11, 56],
  ...
  {
    gates: [64, 47],
    path: 'M 282,88 L 282,112',
  },
  // 61-24 (Head↔Ajna center)
  {
    gates: [61, 24],
    path: 'M 300,88 L 300,112',
  },
  // 63-4 (Head↔Ajna right)
  {
    gates: [63, 4],
    path: 'M 318,88 L 318,112',
  },
